...
// Plugin constants
define('AZURACAST_SONG_HISTORY_VERSION', '0.0.17');
...
class AzuraCast_Song_History {
    ...
    public function activate() {
        ...
        $installed_version = get_option('azuracast_song_history_version', '0.0.0');
        if (version_compare($installed_version, AZURACAST_SONG_HISTORY_VERSION, '<')) {
            // Clear all cached data when updating - include API class first if it exists
            $api_file = AZURACAST_SONG_HISTORY_PLUGIN_PATH . 'includes/class-api.php';
            ...
            update_option('azuracast_song_history_version', AZURACAST_SONG_HISTORY_VERSION);
        }
